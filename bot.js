...
.setTitle('Under Bot Info')
.setURL('https://discordapp.com/api/oauth2/authorize?client_id=505346451019399177&permissions=8&scope=bot')
...
var message = "zg";
         const embed = new Discord.RichEmbed()
     .setColor("GOLD")
     .setTitle('Under Bot Link Click Here .!')
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=505346451019399177&permissions=8&scope=bot')
  .setDescription(`**
